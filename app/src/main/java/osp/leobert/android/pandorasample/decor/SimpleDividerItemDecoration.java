...
public class SimpleDividerItemDecoration extends DividerItemDecoration {
    ...
    void setIgnoreDelegate(@Nullable IgnoreDelegate ignoreDelegate) {
    ...
    protected boolean isIgnore(int pos) {
        if (ignoreDelegate != null)
            return ignoreDelegate.isIgnore(pos);
        return false;
    }
    ...
    ///////////////////////////////////////////////////////////////////////////
    // 临时性的代码，不适合作为DividerItemDecoration的子类了，重构是考虑
    ///////////////////////////////////////////////////////////////////////////
